...
const HomeTokenTable = () => {
  const { theme } = useContext(ThemeContext);
  return (
    <>
      <div className="flex flex-col mt-9 border border-y border-gray-100 rounded">
                ...
                >
                  <td className="py-4 flex items-center uppercase">
                    ...
                    <img
                      ...
                      src="https://firebasestorage.googleapis.com/v0/b/bmc-database-f73bd.appspot.com/o/IMO%2FIMonster%2F1.jpg3b77b299-f41b-4cf6-ba8b-562b4bf239ba?alt=media&token=e9ca679a-f090-443e-b276-a6ec3efffed0"
                      alt="alt"
                    />
                    <span>
                  ...
                  <td className="py-4">342,3,3,3</td>
                  <td className="py-4">3.45%</td>
                  <td
                    className={-0.3 > 0 ? "text-green py-4" : "text-red py-4"}
                  >
                    {Number(343333333).toFixed(2)}
                  </td>
                  <td className={3 > 0 ? "text-green py-4" : "text-red py-4"}>
                    {Number(233333).toFixed(2)}
                  </td>
                  <td className={6 > 0 ? "text-green py-4" : "text-red py-4"}>
                    {Number(3232).toFixed(2)}
                  </td>
                </tr>
              );
            })}
