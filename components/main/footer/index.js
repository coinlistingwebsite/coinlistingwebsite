    ...
    <div>
      ...
      <footer className="footer p-10 max-w-7xl mx-auto text-base-content">
        <aside>
          ...
          <p>© 2024 BullishMarketCap. All Rights Reserved.</p>
        ...
        <nav>
          <h6 className="footer-title">Marketing</h6>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/crypto-twitter-influencers"
            target="_blank"
          >
            Crypto Twitter Inflencers
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/youtubers-global"
            target="_blank"
          >
            Youtubers (Global)
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/worldwide-crypto-marketing-agency"
            target="_blank"
          >
            Worldwide Crypto MArketing Agency
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/angel-investors"
            target="_blank"
          >
            Angel Investors
          </a>
        ...
        <nav>
          ...
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/design-partners"
            target="_blank"
          >
            Design Partners
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/contract-developers"
            target="_blank"
          >
            Contract Developers
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/safu-developers"
            target="_blank"
          >
            Safu Developers
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/dapp-+-web-developers"
            target="_blank"
          >
            Dapp + Web Developers
          </a>
        ...
        <nav>
          ...
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs"
            target="_blank"
          >
            Audit Firms
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/amas-+-calls-telegram"
            target="_blank"
          >
            AMAs + Calls (Telegram)
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/ido-platforms"
            target="_blank"
          >
            IDO platforms
          </a>
          <a
            className="link link-hover"
            href="https://bullishmarketcap.gitbook.io/docs/ieo-platforms"
            target="_blank"
          >
            IEO platforms
          </a>
