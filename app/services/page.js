        ...
        <div className="card card-compact shadow-xl">
          <figure>
            <BlurImage
              ...
              alt="Bullishmarketcap Telegram Bot Service"
              height={200}
              width={300}
            />
          </figure>
        ...
        <div className="card card-compact shadow-xl">
          <figure>
            <BlurImage
              ...
              alt="Bullishmarketcap Fullstack Developer"
              height={200}
              width={300}
            />
          </figure>
        ...
        <div className="card card-compact shadow-xl">
          <figure>
            <BlurImage
              ...
              alt=" Telegram Shilling & Fomo Support"
              height={200}
              width={300}
            />
          </figure>
